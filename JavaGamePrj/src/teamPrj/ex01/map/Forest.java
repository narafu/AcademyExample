...
public class Forest {
	...
	public Forest() {
		...
		NumX = Code.ForestNumX;
		NumY = Code.ForestNumY;
	}
	...
	public void draw(Graphics g) {
		...
		for (int x = 0; x < NumX; x++) {
			for (int y = 0; y < NumY; y++)
				g.drawImage(img, Code.TILE_SIZE * x, Code.TILE_SIZE * y, Code.TILE_SIZE * (x + 1),
						Code.TILE_SIZE * (y + 1), 0, 0, width, height, GameCanvas.getInstance());
		}
