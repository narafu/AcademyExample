...
public class OmokCanvas extends Canvas implements Receiver {
	...
	private Omok[] omoks;
	private int[][] board;
	private int widthWinlose, heightWinlose;
	...
	public void paint(Graphics g) {
		...
		if (start == false) {
			...
			bufG.drawImage(img, 50, 150, 200, 300, 0, 0, 38, 38, this);
			switch (turn % 3 + 1) {
			case WHITE:
				img = imgWhite;
				break;
			...
			bufG.drawImage(img, 50, 500, 200, 650, 0, 0, 38, 38, this);
