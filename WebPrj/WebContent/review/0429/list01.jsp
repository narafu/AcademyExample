<%@page import="review._0429.entity.NoticeView01"%>
				...
				<div class="notice margin-top">
					...
					<table class="table">
						...
						<tbody>
							...
							<%
								List<NoticeView01> list = (List<NoticeView01>) request.getAttribute("list");
							for (NoticeView01 n : list) {
							...
							<tr>
								...
								<td class="title indent text-align-left"><a
									href="/review/_0429/controller/detail01?id=<%=n.getId()%>"><%=n.getTitle()%></a></td>
								<td><%=n.getId()%></td>
								<td><%=n.getRegdate()%></td>
								<td><%=n.getHit()%></td>
							</tr>
