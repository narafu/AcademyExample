			...
			<main class="main">
				...
				<form action="list" method="post">
								...
								<c:forEach var="n" items="${list}">
									<tr>
										...
										<td class="title indent text-align-left"><a
											href="detail?id=${n.id}">${n.title}</a> <span>[${n.cmtCount}]</span>
										</td>
										<td>${n.writerId}</td>
										<td>${n.regdate}</td>
										<td>${n.hit}</td>
										<td><input type="checkbox" name="openId" value="${n.id}"></td>
										<td><input type="checkbox" name="delId" value="${n.id}"></td>
									</tr>
								</c:forEach>
					...
					<div class="indexer margin-top align-right">
						...
						<div>
							<span class="text-orange text-strong">${page}</span> <span>/</span>
							<span>${lastNum}</span> <span>pages</span>
						</div>
					</div>
				...
				<div class="margin-top align-center pager">
					...
					<ul class="-list- center">
						<c:forEach var="i" begin="0" end="4">
							<c:if test="${startNum+i<lastNum+1}">
