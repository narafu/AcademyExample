...
public class OmokCanvas extends Canvas {
	...
	public OmokCanvas() {
		...
		widthwinlose = imgwinlose.getWidth(this) / 2;
	...
	public void paint(Graphics g) {
		...
		int middleX = widthBoard + widthCase * 2;
		int middleY = heightBoard;

		if (exitIndex == 1)
			bufG.drawImage(imgwinlose, middleX / 2 - widthwinlose / 2, middleY / 2 - widthwinlose / 2, this);
