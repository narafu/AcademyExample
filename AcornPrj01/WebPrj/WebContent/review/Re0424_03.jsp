...
<%@page import="review.NoticeService02"%>
<%@page import="review.Notice02"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>

<%
	NoticeService02 service = new NoticeService02();
List<Notice02> list = service.getNoticeList();
%>
						...
						<tbody>
							...
							<tr>
								...
								<td class="title indent text-align-left"><a
									href="detail.html"><%=n.getTitle()%></a></td>
								<td><%=n.getId()%></td>
								<td><%=n.getRegdate()%></td>
								<td><%=n.getHit()%></td>
							</tr>
